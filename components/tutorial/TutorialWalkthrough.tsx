...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  {
    id: 2,
    title: "Follow the Digital Clues",
    explanation: `This is your main investigation surface. It contains raw system logs from tools like Sysmon, Zeek, Suricata, and more. These logs show things like network connections, process execution, and file changes.`,
  ...
  {
    id: 3,
    title: "Investigate What You Found",
    explanation: `Found a suspicious IP or file hash? Don't just guess. Use built-in OSINT tools (like VirusTotal, OTX, AbuseIPDB) to validate your findings. These tools tell you whether an IOC has been reported by other security professionals around the world.`,
    goal: "Click on an IP/domain/hash in the logs, use the enrichment panel to check its reputation, and look at indicators like malicious reports, last seen, first submission. Confirm whether something is benign or malicious based on open intelligence.",
    highlightSelector: '[data-tutorial="ioc-panel"]',
    position: 'right',
  },
  {
    id: 4,
    title: "Understand the Attacker's Playbook",
    explanation: `Now that you've found suspicious activity, ask: What technique was used? Use the built-in MITRE ATT&CK Navigator to map the behavior you saw in the logs to real-world attacker techniques.`,
  ...
  {
    id: 5,
    title: "Make the Call: What Happened?",
    explanation: `When you're ready, finalize the investigation. You'll receive a score and feedback — but more importantly, you'll learn what you missed and how you did. This is how real SOC analysts sharpen their skills.`,
    goal: "Submit your findings, get your skill badge, and try again with a different scenario or higher difficulty. Use the 'Finalize Investigation' button when you've tagged all suspicious IOCs.",
