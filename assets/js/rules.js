...
export const KB_DATA = [
  ...
  { name: 'LockBit 5.0', type: 'ransomware', active: true, desc: 'Resurgent RaaS after Operation Cronos disruption. Cross-platform variant targeting Windows, Linux, VMware ESXi. Criminal RaaS operation with resilient infrastructure.', chips: ['v5.0', 'Cross-platform', 'RaaS'] },
